...
The branch `feature/teammate_branch` has been created to simulate work done by a teammate.
...
Git uses a specific syntax to show conflicting sections of code. In this case, two students
added themselves to `yearbook.md` in the same location of the file. Git doesn't know which
student should actually be there, so it kept all the content and will not let you move on
